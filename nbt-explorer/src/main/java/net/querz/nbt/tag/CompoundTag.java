...
public class CompoundTag extends Tag<Map<String, Tag<?>>>
    ...
    public Tag<?> set(String key, boolean value) {
        return put(key, new ByteTag(value));
    }

    public Tag<?> set(String key, byte value) {
        return put(key, new ByteTag(value));
    }

    public Tag<?> set(String key, short value) {
        return put(key, new ShortTag(value));
    }

    public Tag<?> set(String key, int value) {
        return put(key, new IntTag(value));
    }

    public Tag<?> set(String key, long value) {
        return put(key, new LongTag(value));
    }

    public Tag<?> set(String key, float value) {
        return put(key, new FloatTag(value));
    }

    public Tag<?> set(String key, double value) {
        return put(key, new DoubleTag(value));
    }

    public Tag<?> set(String key, String value) {
        return put(key, new StringTag(value));
    }
