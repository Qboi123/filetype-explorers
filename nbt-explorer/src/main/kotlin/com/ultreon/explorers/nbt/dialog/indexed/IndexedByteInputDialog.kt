...
class IndexedByteInputDialog(parentShell: Shell?) : TitleAreaDialog(parentShell) {
    var index: Int = 0
    var value: Byte = 0
    ...
    override fun create() {
        super.create()
        setTitle("Create New Byte Value")
