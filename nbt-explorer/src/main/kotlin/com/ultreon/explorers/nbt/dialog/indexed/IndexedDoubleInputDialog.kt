...
class IndexedDoubleInputDialog(parentShell: Shell?) : TitleAreaDialog(parentShell) {
    var index: Int = 0
    var value: Double = .0
    ...
    override fun create() {
        super.create()
        setTitle("Create New Double Value")
