...
class IndexedFloatInputDialog(parentShell: Shell?) : TitleAreaDialog(parentShell) {
    var index: Int = 0
    var value: Float = 0f
    ...
    override fun create() {
        super.create()
        setTitle("Create New Float Value")
